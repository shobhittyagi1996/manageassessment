		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Assessment Template",
									"targetURL": "#comsapmanageassessment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmanageassessment-display": {
								"semanticObject": "comsapmanageassessment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.manageassessment",
									"url": sap.ui.require.toUrl("com/sap/manageassessment")
								}
							}
						}
					}
